...
export const stageCopy: Record<StageName, { goal: string; task: string }> = {
  ...
  能力关卡: {
    goal: "制造现实约束，观察候选人的判断力、抗压能力、优先级能力、证据链设计和 AI 使用边界。",
    task:
      "现在老板要求两周内上线可演示版本，但研发只有 1 名前端、1 名后端，AI 能力只能调用现成 API。请重新调整方案，并说明：你会砍掉什么，哪些功能必须保留，没有录屏怎么保留证据，AI 评委误判怎么处理，如何避免候选人纯靠 AI 代答，如果只能做 3 个页面你选哪 3 个。"
  }
};
