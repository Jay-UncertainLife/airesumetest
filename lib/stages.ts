...
export const stageCopy: Record<StageName, { goal: string; task: string }> = {
  面试关卡准备: {
    ...
    task: "系统将基于目标岗位配置、候选人简历画像和 AI 考核官参与度生成基础关卡与能力关卡策略。"
  },
  基础关卡: {
    goal: "确认候选人是否理解角色职责、业务目标和问题拆解。",
    task:
      "你是一名 AI 产品负责人。公司准备做一个面向招聘场景的 AI 考核产品，请你在 10 分钟内提出一个 MVP 方案。请说明：目标用户是谁？核心场景是什么？为什么它不是普通面试系统？MVP 最小闭环是什么？你会先做哪些功能，砍掉哪些功能？"
  },
  能力关卡: {
